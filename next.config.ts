        ...
        headers: [
          // Content Security Policy
          {
            ...
            value: [
              ...
              "connect-src 'self' data: https://*.clerk.accounts.dev https://*.stripe.com https://api.openai.com https://unpkg.com https://*.cloudflare.com https://clerk-telemetry.com https://fonts.gstatic.com https://cdn.jsdelivr.net",
